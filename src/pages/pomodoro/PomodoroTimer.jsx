...
export default function PomodoroTimer() {
  ...
  // ── Shared UI pieces used in both portrait and landscape layouts ──
  ...
  // Animation block: scaled animation with watermark clock overlaid
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a18] select-none overflow-hidden">
      ...
      {/* Ghost intention — absolute so it doesn't affect either layout */}
      ...
      {/* ── PORTRAIT layout (hidden in landscape) ── */}
      ...
      {/* ── LANDSCAPE layout (hidden in portrait) ── */}
      <div className="hidden landscape:flex landscape:flex-row landscape:items-center landscape:min-h-screen landscape:px-6 landscape:py-3 landscape:gap-6">
        ...
        {/* Left column: session info + full-opacity clock + play */}
        ...
        {/* Right column: animation (if enabled) + controls */}
