export default function HourglassAnim({ progress, phase }) {
  ...
  // Top chamber: sand surface moves down as time passes (progress 0→1)
  // surface y = 10 + progress * 68, rect height = (1-progress) * 68
  const topSurfaceY = 10 + progress * 68
  const topSandH = (1 - progress) * 68

  // Bottom chamber: sand level rises (piles up from y=150)
  // rect y = 150 - progress * 68, height = progress * 68
